...
@InputType()
class RecommendationCreateNestedManyWithoutEventsInput {
...
export { RecommendationCreateNestedManyWithoutEventsInput as RecommendationCreateNestedManyWithoutEventsInput };
